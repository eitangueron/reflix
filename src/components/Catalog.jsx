...
import Movie from './Movie'
  ...
  class Catalog extends Component {
    ...
    changeMovieStatus = (moviesID) => {
      const movieToChangeIndex = this.state.moviesData.findIndex(movie => movie.id === moviesID)
      const newMoviesData = [...this.state.moviesData]
    ...
    return (
          <div id='catalog'>
            ...
            <div id="movies-catalog">
              {this.state.moviesData.map(movie => <Movie movieInfo={movie}/>)}
            </div>
          </div>
